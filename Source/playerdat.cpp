...
const _sfx_id herosounds[static_cast<size_t>(HeroClass::Necromancer)][enum_size<HeroSpeech>::value] = {
	// clang-format off
...
{
	// The Necromancer currently shares the Sorcerer's voice set.
	if (heroClass == HeroClass::Necromancer)
		heroClass = HeroClass::Sorcerer;
	return herosounds[static_cast<size_t>(heroClass)];
}
...
/* HeroClass::Necromancer */ { N_("Necromancer"), "sorceror",   10,      30,         20,        10,        40,    200,        100,        60,         10,  (4 << 6),                     (8 << 6),  (1 << 6),  (2 << 6), (1 << 6),                    (2 << 6),                    (1 << 6),                     (2 << 6), SpellID::StaffRecharge },
	// clang-format on
};
...
/* HeroClass::Necromancer */ {    96,     96,      128,   128,    96,      96,         128,    128,     128,     128 },
	// clang-format on
};
...
/* HeroClass::Necromancer */ {          20,                 12,                  16,                        9,          16,               12,                16,                     12,        20,             16,        24,             16,         16,              12,               16,                    12,          16,               12,          8,              8,              6,          20,            12,              8,             20,                 8,                  8 },
	// clang-format on
};
